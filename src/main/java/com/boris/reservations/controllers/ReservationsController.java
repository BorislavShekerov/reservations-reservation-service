...
public class ReservationsController {
	...
	public Reservation addReservation(@AuthenticationPrincipal UserContext userContext,@RequestBody Reservation reservationToAdd){
		User userIssuingReservation = new User(userContext.getEmail(), userContext.getFirstName(), userContext.getLastName());
		Table tableReserved = reservationToAdd.getTableReserved();
		
		tableReserved.setTablePrimaryKey(new TablePrimaryKey(tableReserved.getTableNumberSentWithRequest(), reservationToAdd.getVenue()));
